...
class BoxProcessor(object):
    ...
    def __init__(self, box_token="<box>", value_format=".3f", value_sep=", ", bounds=("[", "]")):
    ...
    def _format_box(self, box):
        return self.bounds[0] + self.sep.join([self._format_value(pos) for pos in box]) + self.bounds[1]
    ...
    def __call__(self, input_str, boxes):
        ...
        assert num_boxes == len(box_strings), \
...
if __name__ == "__main__":
    # box (x1, y1, x2, y2)
    input_str = "Please tell me more about the rectangular section <box> in the photo <image>."
